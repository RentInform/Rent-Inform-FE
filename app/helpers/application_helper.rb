module ApplicationHelper
  ...
  def map(lat, lon)
    "https://www.mapquestapi.com/staticmap/v5/map?locations=#{lat}, #{lon}&size=1000, 1000&zoom=13&center=#{lat}, #{lon}&defaultMarker=marker-lg-1D4ED8&key=#{ENV['MAPQUEST_KEY']}"
  end
